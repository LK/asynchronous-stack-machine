...
def prsim_preamble():
    ...
    clear_chan_data('p.chan_STACK_POP', 8)
    print('set p.chan_STACK_PUSH.a 0')
    print('set p.chan_STACK_OP.a 0')
    print('set p.chan_STACK_FULL.t 0')
    print('set p.chan_STACK_FULL.f 0')
    print('cycle')
    print('set Reset 0')
    print('set _Reset 1')
    print('cycle')
